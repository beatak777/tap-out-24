...
function MyNav() {
  const initialDropdownItems = [
    { href: './thewake', title: 'The Wake', imageUrl: './src/assets/posters/TheWakeImage.png' },
    { href: './symposium', title: 'Symposium', imageUrl: '' },
    { href: './theconvo', title: 'The Convo', imageUrl: '' },
    ...
    { href: './theeutony', title: 'The Eutony', imageUrl: '' },
